 ...
 *
 * @author Peter Jensen
 * @author modifier Cameron Pickle
 * @version Fall 2012
 */
public class ShapeMover extends JApplet implements MouseListener, MouseMotionListener
{
    // Instance variables.
    ...
    public void init ()
    {
        ...
        shapes = new Shape[5];
        shapes[0] = new Rectangle    ( 30, 40, 20, 40, Color.BLUE);
        shapes[1] = new Square       ( 230, 40, 30, Color.BLACK);
        shapes[2] = new Rectangle    ( 30, 240, 70, 50, Color.GREEN);
        shapes[3] = new Circle       (130,  40, 60, Color.RED);
        shapes[4] = new Circle       ( 30, 140, 40, Color.YELLOW);
